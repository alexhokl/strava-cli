...
func (r ApiGetRouteAsGPXRequest) Execute() (*os.File, *http.Response, error) {
...
//  @return *os.File
func (a *RoutesAPIService) GetRouteAsGPXExecute(r ApiGetRouteAsGPXRequest) (*os.File, *http.Response, error) {
	var (
...
func (r ApiGetRouteAsTCXRequest) Execute() (*os.File, *http.Response, error) {
...
// Execute executes the request
//  @return *os.File
func (a *RoutesAPIService) GetRouteAsTCXExecute(r ApiGetRouteAsTCXRequest) (*os.File, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	// to determine the Accept header
	localVarHTTPHeaderAccepts := []string{"application/tcx+xml"}
